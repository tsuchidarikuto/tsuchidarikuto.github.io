...
window.addEventListener('DOMContentLoaded', event => {
    ...
    const translations = {
        ja: {
            ...
            'about.name.given': '陸斗',
            'about.subtitle': '奈良先端科学技術大学院大学 情報科学領域 修士1年',
            ...
            'projects.mimcare.desc': '高齢者の見守りを目的としたシステムです。高齢者との会話情報を元に、介護施設側のダッシュボードや家族用のアプリケーションに必要な情報を表示します。<a href="https://geiot-comm.naist.jp/" target="_blank" rel="noopener noreferrer">NAIST GEIOT</a>全体2位を獲得し、<a href="https://www.osaka-startup.com/program/sio-accel/" target="_blank" rel="noopener noreferrer">SIOアクセラレーション2025</a>に採択されました。',
            ...
            'publications.msr.title': 'How AI Coding Agents Communicate: A Study of Pull Request Characteristics and Human Review Responses',
            'publications.msr.venue': '第23回 マイニングソフトウェアリポジトリ国際会議（MSR 2026）, pp.878-882',
            'publications.msr.date': '2026年',
            'publications.cwe.title': 'CWE別特化型LLMのアンサンブルによるソースコード脆弱性検出手法の提案',
            'publications.cwe.venue': '情報処理学会 第88回全国大会',
            'publications.cwe.date': '2026年3月',
            'publications.jset.title': '3D教材活用の授業実践が児童の学習意欲に与える効果',
            'publications.jset.venue': '日本教育工学会 2026年春季全国大会',
            'publications.jset.date': '2026年3月',
            'publications.valorant.title': 'Round Outcome Prediction in VALORANT Using Tactical Features from Video Analysis',
            'publications.valorant.venue': '2025 IEEE Conference on Games（CoG 2025）, pp.1-4',
            'publications.valorant.date': '2025年8月',
            'presentations.summit.title': 'An Analysis of Maintenance Activities by Generative AI Adopters on GitHub',
            'presentations.summit.venue': 'AI-Driven Software Engineering Summit for Fostering Next-Generation Researchers ポスターセッション（奈良）',
            'presentations.summit.date': '2025年11月',
            'presentations.github.title': 'GitHub における生成 AI 採用者のメンテナンス活動の分析',
            'presentations.github.venue': '日本ソフトウェア科学会 ソフトウェア工学の基礎ワークショップ <a href="https://fose.jssst.or.jp/fose2025/award.html#FOSE" target="_blank" rel="noopener noreferrer">FOSE2025</a> ポスターセッション',
            ...
            'awards.sio': '<a href="https://www.osaka-startup.com/program/sio-accel/" target="_blank" rel="noopener noreferrer">SIOアクセラレーション2025</a> 採択',
        },
        en: {
            ...
            'about.subtitle': 'M1, Information Science, Nara Institute of Science and Technology',
            ...
            'projects.mimcare.desc': 'A system that supports elder care by surfacing insights from conversation data on facility dashboards and a family app. Won 2nd place overall at <a href="https://geiot-comm.naist.jp/" target="_blank" rel="noopener noreferrer">NAIST GEIOT</a> and was selected for <a href="https://www.osaka-startup.com/program/sio-accel/" target="_blank" rel="noopener noreferrer">SIO Acceleration 2025</a>.',
            ...
            'publications.msr.title': 'How AI Coding Agents Communicate: A Study of Pull Request Characteristics and Human Review Responses',
            'publications.msr.venue': '23rd International Conference on Mining Software Repositories (MSR 2026), pp. 878-882',
            'publications.msr.date': '2026',
            'publications.cwe.title': 'Detecting Source Code Vulnerabilities with an Ensemble of CWE-Specific LLMs',
            'publications.cwe.venue': '88th National Convention of the Information Processing Society of Japan',
            'publications.cwe.date': 'March 2026',
            'publications.jset.title': 'Effects of Lessons Using 3D Teaching Materials on Elementary School Students\' Motivation to Learn',
            'publications.jset.venue': 'Japan Society for Educational Technology, 2026 Spring National Convention',
            'publications.jset.date': 'March 2026',
            'publications.valorant.title': 'Round Outcome Prediction in VALORANT Using Tactical Features from Video Analysis',
            'publications.valorant.venue': '2025 IEEE Conference on Games (CoG 2025), pp. 1-4',
            'publications.valorant.date': 'August 2025',
            'presentations.summit.title': 'An Analysis of Maintenance Activities by Generative AI Adopters on GitHub',
            'presentations.summit.venue': 'AI-Driven Software Engineering Summit for Fostering Next-Generation Researchers, Poster Session (Nara)',
            'presentations.summit.date': 'November 2025',
            'presentations.github.title': 'Analyzing Maintenance Activities of Generative AI Adopters on GitHub',
            'presentations.github.venue': 'Japan Society for Software Science and Technology, Foundations of Software Engineering Workshop <a href="https://fose.jssst.or.jp/fose2025/award.html#FOSE" target="_blank" rel="noopener noreferrer">FOSE2025</a> Poster Session',
            ...
            'awards.sio': 'Selected for <a href="https://www.osaka-startup.com/program/sio-accel/" target="_blank" rel="noopener noreferrer">SIO Acceleration 2025</a>',
        },
    };
